...
// Successor and predecessor don't seem to be working correctly
...
//            System.out.println("\n" + keys[0].getWord());
//            System.out.println(keys[1].getWord());
//            System.out.println(keys[2].getWord());
//            System.out.println(keys[3].getWord());
//            System.out.println(keys[4].getWord() + "\n");
